    ...
    <div className="presentation-controls fixed bottom-0 left-0 right-0 p-4 flex justify-between items-center z-10 backdrop-blur-md bg-black/40">
      <div className="flex items-center gap-2">
        <Button 
          ...
          className="h-9 w-9 border-cyan-700 hover:bg-cyan-900/50 text-cyan-400 hover:text-cyan-300 transition-all duration-300 relative overflow-hidden group glass-button"
        >
